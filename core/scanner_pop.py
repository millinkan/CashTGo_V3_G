...
class Scanner(Screen):
    ...
    def on_save_pressed(self , instance):
        """Save the captured image, perform OCR, and show extracted text in a popup."""
        ...
        try:
            ...
            # Show popup and navigate on close
            popup = self._create_info_popup ( extracted_text , self._get_user_location () )
            popup.bind ( on_dismiss = lambda instance: self._navigate_to_homeB () )
            popup.open ()
